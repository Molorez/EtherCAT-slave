...
void APPL_OutputMapping(UINT16* pData)
{
    ...
    for (j = 0; j < sRxPDOassign.u16SubIndex0; j++)
    {
        ...
        case 0x1601:
            ...
            break;
				case 0x1602:
//					  ((UINT16 *) &sControlData)[1] = SWAPWORD(*pTmpData++);
//						((UINT16 *) &sControlData)[2] = SWAPWORD(*pTmpData++);
							dataxx = SWAPWORD(*pTmpData++);
							dataxx2 = SWAPWORD(*pTmpData++);
            break;
        }
    }
}
...
{
	GPIO_WriteBit(GPIOC, GPIO_Pin_15, (BitAction)sDOOutputs.bLED1);
	GPIO_WriteBit(GPIOC, GPIO_Pin_14, (BitAction)sDOOutputs.bLED2);
	GPIO_WriteBit(GPIOC, GPIO_Pin_13, (BitAction)sDOOutputs.bLED3);
	GPIO_WriteBit(GPIOE, GPIO_Pin_6,  (BitAction)sDOOutputs.bLED4);
	GPIO_WriteBit(GPIOE, GPIO_Pin_5,  (BitAction)sDOOutputs.bLED5);
	GPIO_WriteBit(GPIOE, GPIO_Pin_4,  (BitAction)sDOOutputs.bLED6);
	GPIO_WriteBit(GPIOE, GPIO_Pin_3,  (BitAction)sDOOutputs.bLED7);
	GPIO_WriteBit(GPIOE, GPIO_Pin_2,  (BitAction)sDOOutputs.bLED8);	
	
	sDIInputs.bSwitch1    = GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_1);
  sDIInputs.bSwitch2    = GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_0);
	sDIInputs.bSwitch3    = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_9);
  sDIInputs.bSwitch4    = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_8);
	sDIInputs.bSwitch5    = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_6);
  sDIInputs.bSwitch6    = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_5);
	sDIInputs.bSwitch7    = GPIO_ReadInputDataBit(GPIOG, GPIO_Pin_15);
  sDIInputs.bSwitch8    = GPIO_ReadInputDataBit(GPIOG, GPIO_Pin_14);
...
//		while(!(ADC_GetFlagStatus(ADC1, ADC_FLAG_EOC)==SET));
    ...
    sAIInputs.bTxPDOToggle ^= 1;
		sAIInputs.b2Limit1 = 1;
		sAIInputs.b2Limit2 = 3;
		sAIInputs.bOverrange = 1;
		sAIInputs.bUnderrange = 1;
		sAIInputs.bTxPDOState ^= 1;
		
//		dataxx = sControlData.controldata;
